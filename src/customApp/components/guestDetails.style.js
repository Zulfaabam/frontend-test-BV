...
const WDGuestDetailsListStyleWrapper = styled.div`
  width: 100%;
  display: flex;
...
`
const GuestDetailsListStyleWrapper = WithDirection(
  WDGuestDetailsListStyleWrapper
)

export { GuestDetailsListStyleWrapper, GuestDetailsStyleWrapper }
